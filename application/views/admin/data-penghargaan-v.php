<div style="margin-top: 14px; background-color: white;padding: 30px">
	...
	<table id="add-row" class="display table table-striped table-hover">
		...
		<tbody>
			...
			<?php else: ?>
				<tr>
					<td class=" text-center" colspan="7">Belum ada data penghargaan</td>
				</tr>
			<?php endif ?>
		</tbody>
	</table>
...
<div class="modal fade" id="addpenghargaan" tabindex="-1" role="dialog" aria-labelledby="addpenghargaan" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<form action="<?php echo base_url('index.php/admin/pegawai/create_penghargaan/'.$hasil->id_pegawai) ?>" method="post" enctype="multipart/form-data">
