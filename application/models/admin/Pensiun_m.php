...
class Pensiun_m extends CI_Model
{
	...
	public function cari_pegawaipensiun($string){
		$this->db->like('nama_pegawai', $string);
		$this->db->limit('5');
		$query = $this->db->get('data_pegawai');
		return $query->result();
	}
	public function cari_pegawaipensiunbup($string){
		$this->db->like('nama_pegawai', $string);
		$this->db->limit('5');
		$query = $this->db->get('data_pegawai');
		return $query->result();
	...
	public function get_pensiundini(){
		$this->db->order_by('id_pensiun','desc');
		$query = $this->db->get('data_pensiun');
		return $query->result();
	}
