		...
		<div class="card-header">
			<div class="media">
				<div class="media-body">
					<h5 class="mt-0 mb-1">Daftar Pengangkatan PNS</h5>
				</div>
				<div class="ml-3">
					<button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addpengangkatan">
			...
			<table class="table">
				...
				<?php foreach ($hasil as $data): ?>
					<tr>
						...
						<td class=""><a href="<?php echo base_url('index.php/admin/cspkpb/detail_pengangkatan/'.$data->id_form_pengangkatan) ?>"><?php echo $this->Admin_m->detail_data_order('data_pegawai','id_pegawai',$data->id_pegawai)->nama_pegawai; ?></a></td>
...
<!-- Modal -->
<div class="modal fade" id="addpengangkatan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
$('#caripegawai').keyup(function() { // Jika select box id kurir dipilih
  	...
  	$.ajax({
            ...
            url: "<?php echo base_url('index.php/admin/cspkpb/caripegawai/'); ?>",
