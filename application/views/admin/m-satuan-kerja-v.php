		...
		<div class="card-body">
			<div class="col-md-12">
				...
				<div class="media-right">
					<button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#addmastersatuankerja"><i class="fa fa-plus"></i> Tambah Data </button>
				</div>
			</div>
			<hr/>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<input type="text" class="form-control border-dark" id="nama_satuan_kerja" name="nama_satuan_kerja" placeholder="NAMA SATUAN KERJA" >
								</div>
								<div class="form-group">
									<label class="text-info" for="parent_unit">PARENT UNIT</label>
									<input type="text" class="form-control border-dark" id="parent_unit" name="parent_unit" placeholder="PARENT UNIT" >
								</div>
							</div>
						</div>
