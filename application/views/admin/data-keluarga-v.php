			...
			<table id="basic-datatables" class="display table table-striped table-hover" >
				<thead>
					<tr>
						...
						<td class="">Hub. Keluarga</td>
						<td class="">Status Kawin</td>
						<td class="">Tgl Nikah</td>
						<td class="">Tgl Cerai</td>
						<td class="">Tgl Meninggal</td>
						<td class="">Pekerjaan</td>
						<td class="">No Kartu Suami/Istri</td>
					...
					<?php if ($keluarga == TRUE): ?>
						...
						<?php foreach ($keluarga as $data): ?>
							<tr>
								...
								<td class=""><?php echo $data->nama_anggota_keluarga; ?></td>
								<td class=""><?php echo $data->tanggal_lahir; ?></td>
								<td class=""><?php echo $this->Admin_m->detail_data_order('master_status_dalam_keluarga','id',$data->status_keluarga)->status_keluarga;?></td>
								<td class=""><?php echo $this->Admin_m->detail_data_order('master_status_kawin','id',$data->status_kawin)->status_kawin;?></td>
								<td class=""><?php echo $data->tanggal_nikah; ?></td>
								<td class=""><?php echo $data->tanggal_cerai_meninggal; ?></td>
								<td class=""><?php echo $data->tanggal_meninggal; ?></td>
								<td class=""><?php echo $data->pekerjaan; ?></td>
								<td class=""><?php echo $data->no_kartu; ?></td>
								<td class="">
