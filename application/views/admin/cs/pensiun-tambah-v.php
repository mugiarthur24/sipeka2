<div class="p-4">
  <div class="card">
    <div class="card-header">
      <h3>Formulir Permintaan Pensiun</h3>
    </div>
    <div class="container">
      <div class="row">
      <div class="col">
  ...
  <div class="mt-4">
    <div class="card">
      ...
      <div class="card-body">
        <form action="<?php echo base_url('index.php/admin/cspensiun/pensiun2/'.$hasil->id_pegawai) ?>" method="post" enctype="multipart/form-data">
