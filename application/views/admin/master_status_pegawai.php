	...
	<div class="ktk-jdl">
		<div class="media">
			...
			<div class="media-right">
				<button type="button" class="btn btn-outline-danger btn-sm" data-toggle="modal" data-target="#addstatuspegawai"><i class="material-icons">note_add</i> Tambah data </button>
			</div>
		</div>
	</div>
		...
		<table class="table table-hover">
			<thead>
				<tr class="bg-app text-light">
					...
					<td class=""><i class="material-icons">assignment_ind</i>Status Pegawai</td>
					<td class=""><i class="material-icons">power_settings_new</i>Aksi</td>
				</tr>
			</thead>
			<tbody>
				<?php $no = 1 ?>
				<?php foreach ($hasil as $data): ?>
					<tr>
						...
						<td class=" text-secondary"><?php echo $data->status_pegawai; ?></a></td>
						<td class="">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="text" class="form-control border-dark" id="status_pegawai" name="status_pegawai" placeholder="STATUS" >
							</div>
						</div>
					</div>
				</div>
