		...
		<div class="card-header">
			<div class="media">
				<div class="media-body">
					<h5 class="mt-0 mb-1">Daftar Permintaan Pensiun Janda/Duda</h5>
				</div>
				<div class="ml-3">
					<button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#addpensiunjandaduda">
			...
			<table class="table">
				...
				<?php foreach ($hasil as $data): ?>
					<tr>
						...
						<td class=""><a href="<?php echo base_url('index.php/admin/cspensiun/detail_pensiunjandaduda/'.$data->id_form_pensiunjandaduda) ?>"><?php echo $this->Admin_m->detail_data_order('data_pegawai','id_pegawai',$data->id_pegawai)->nama_pegawai; ?></a></td>
...
<!-- Modal -->
<div class="modal fade" id="addpensiunjandaduda" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<form action="<?php echo base_url('index.php/admin/cspensiun/pensiunjandaduda') ?>" method="post">
				<div class="modal-body">
					<div class="row">
						<div class="col">
							<div class="form-group">
								<label>Cari Pegawai</label>
								<input type="text" name="tgl_masuk" id="caripegawaipensiunjandaduda" class="form-control border-dark" placeholder="Masukkan Nama Pegawai">
...
<script type="text/javascript">
		// 
$('#caripegawaipensiunjandaduda').keyup(function() { // Jika select box id kurir dipilih
  	var katakuncip = $('#caripegawaipensiunjandaduda').val();
  	$.ajax({
            type: 'post', // Metode pengiriman data menggunakan POST
            url: "<?php echo base_url('index.php/admin/cspensiun/caripegawaipensiunjandaduda/'); ?>",
