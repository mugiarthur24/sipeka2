		...
		<div class="row">
			<div class="col">
				<div class="form-group">
					...
					<input type="text" class="form-control border-dark" id="gelar_dpn" name="gelar_dpn" placeholder="GELAR DEPAN" value="<?php echo $hasil->gelar_dpn ?>">
				</div>
							
				
				<div class="form-group">
					<label class="text-info" for="nama_pegawai">NAMA LENGKAP</label>
					<input type="text" class="form-control border-dark" id="nip" name="nama_pegawai" placeholder="NAMA LENGKAP TANPA GELAR" value="<?php echo $hasil->nama_pegawai ?>">
				</div>
				<div class="form-group">
					<label class="text-info" for="nama_pegawai">GELAR BELAKANG</label>
					<input type="text" class="form-control border-dark" id="gelar_belakang" name="gelar_belakang" placeholder="GELAR BELAKANG" value="<?php echo $hasil->gelar_belakang ?>">
				</div>
				<div class="form-group">
					<label class="text-info" for="nip">NIP</label>
					<input type="text" class="form-control border-dark" id="nip" name="nip" placeholder="NIP" value="<?php echo $hasil->nip ?>">
				</div>
				<div class="form-group">
					<label class="text-info" for="nip_lama">NIP LAMA</label>
					<input type="text" class="form-control border-dark" id="nip_lama" name="nip_lama" placeholder="NIP LAMA" value="<?php echo $hasil->nip_lama ?>">
				</div>
				<div class="form-group">
					<label class="text-info" for="no_kartu_pegawai">NOMOR KARTU PEGAWAI</label>
					<input type="text" class="form-control border-dark" id="no_kartu_pegawai" name="no_kartu_pegawai" placeholder="NOMOR KARTU PEGAWAI" value="<?php echo $hasil->no_kartu_pegawai ?>">
				</div>
				<div class="form-group">
					<label class="text-info" for="no_npwp">NPWP</label>
					<input type="text" class="form-control border-dark" id="no_npwp" name="no_npwp" placeholder="NPWP" value="<?php echo $hasil->no_npwp ?>">
				</div>
				<div class="form-group">
					<label class="text-info" for="kartu_askes_pegawai">NOMOR KARTU ASKES PEGAWAI</label>
					<input type="text" class="form-control border-dark" id="kartu_askes_pegawai" name="kartu_askes_pegawai" placeholder="NOMOR KARTU ASKES PEGAWAI" value="<?php echo $hasil->kartu_askes_pegawai ?>">
				</div>
				<div class="form-group">
					<div class="row">
						<div class="col-md-6">
							<label class="text-info" for="tmt_cpns">TMT CPNS</label>
							<input type="date" class="form-control border-dark" id="tmt_cpns" name="tmt_cpns" placeholder="TMT CPNS" value="<?php echo $hasil->tmt_cpns ?>">
						</div>
						<div class="col-md-6">
					<label class="text-info" for="tmt_pns">TMT PNS</label>
					<input type="date" class="form-control border-dark" id="tmt_pns" name="tmt_pns" placeholder="TMT PNS" value="<?php echo $hasil->tmt_pns ?>">
						</div>
					</div>
				</div>
				<div class="form-group">
					<label class="text-info" for="gaji_pokok">GAJI POKOK</label>
					<input type="text" class="form-control border-dark" id="gaji_pokok" name="gaji_pokok" placeholder="GAJI POKOK" value="<?php echo $hasil->gaji_pokok ?>">
				</div>
			</div>
			...
			<div class="col">
				<div class="form-group">
					...
					<input type="text" class="form-control border-dark" id="tmpt_lahir" name="tempat_lahir" placeholder="KOTA KELAHIRAN/TEMPAT LAHIR" value="<?php echo $hasil->tempat_lahir ?>">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control border-dark" id="no_hp" name="no_hp" placeholder="Nomor Handphone" value="<?php echo $hasil->no_hp?>">
				</div>
				<div class="form-group">
					<label class="text-info" for="email">EMAIL</label>
                    <input type="text" class="form-control border-dark" id="email" name="email" placeholder="EMAIL" value="<?php echo $hasil->email?>">
				</div>
				<div class="form-group">
					<label class="text-info" for="tanggal_lahir">NOMOR KK</label>
					<input type="text" class="form-control border-dark" id="nomor_kk" name="nomor_kk" placeholder="Nomor Kartu Keluarga" value="<?php echo $hasil->nomor_kk ?>">
				</div>
				<div class="form-group">
					<label class="text-info" for="tanggal_lahir">NOMOR KTP</label>
					<input type="text" class="form-control border-dark" id="nomor_ktp" name="nomor_ktp" placeholder="Nomor KTP" value="<?php echo $hasil->nomor_ktp ?>">
				</div>
				<div class="form-group">
		...
		<div class="row">
			<div class="col">
				<div class="form-group">
					...
					<textarea id="alamat" name="alamat" class="form-control border-dark"><?php echo $hasil->alamat; ?></textarea>
				</div>
			</div>
		</div>
