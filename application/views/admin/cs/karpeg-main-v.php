		...
		<div class="card-header">
			<div class="media">
				<div class="media-body">
					<h5 class="mt-0 mb-1">Daftar Pengajuan Karpeg (Kartu Pegawai)</h5>
				</div>
				<div class="ml-3">
					<button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#addkarpeg">
			...
			<table class="table">
				...
				<?php foreach ($hasil as $data): ?>
					<tr>
						...
						<td class=""><a href="<?php echo base_url('index.php/admin/cskartu/detail_karpeg/'.$data->id_form_karpeg) ?>"><?php echo $this->Admin_m->detail_data_order('data_pegawai','id_pegawai',$data->id_pegawai)->nama_pegawai; ?></a></td>
...
<!-- Modal -->
<div class="modal fade" id="addkarpeg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<form action="<?php echo base_url('index.php/admin/cskartu/cpwk_keluar') ?>" method="post">
...
$('#caripegawai').keyup(function() { // Jika select box id kurir dipilih
  	...
  	$.ajax({
            ...
            url: "<?php echo base_url('index.php/admin/cskartu/caripegawai/'); ?>",
