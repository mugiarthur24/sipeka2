		...
		<div class="card-header">
			<div class="media">
				<div class="media-body">
					<h5 class="mt-0 mb-1">Daftar Pengajuan Surat Tugas Belajar</h5>
				</div>
				<div class="ml-3">
			...
			<table class="table">
				...
				<?php foreach ($hasil as $data): ?>
					<tr>
						...
						<td class=""><a href="<?php echo base_url('index.php/admin/cssuket/detail_tugasbelajar/'.@$data->id_form_tugasbelajar) ?>"><?php echo $this->Admin_m->detail_data_order('data_pegawai','id_pegawai',$data->id_pegawai)->nama_pegawai; ?></a></td>
...
$('#caripegawai').keyup(function() { // Jika select box id kurir dipilih
  	...
  	$.ajax({
            ...
            url: "<?php echo base_url('index.php/admin/cssuket/caripegawaistb/'); ?>",
