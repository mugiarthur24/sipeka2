<div class="p-4">
  <div class="card">
    <div class="card-header">
      <h3>Formulir Surat Ijin Cuti</h3>
    </div>
    <div class="container">
      <div class="row">
      <div class="col">
  ...
  <div class="mt-4">
    <div class="card">
      ...
      <div class="card-body">
        <form action="<?php echo base_url('index.php/admin/cssuket/cuti2/'.$hasil->id_pegawai) ?>" method="post" enctype="multipart/form-data">
          ...
          <table class="table">
            ...
            <tbody>
              <tr>
                <th scope="row">1</th>
                <td>Pengajuan permohonan dari pemohon secara tertulis kepada kepala OPD dengan catatan pertimbangan atasan langsung</td>
                <td>
                ...
                <td>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <tr>
                        <th scope="row">3</th>
                        <td>Fotocopy SK CPNS, PNS , Jabatan bagi yang menduduki jabatan dan Pangkat terakhir (dilegalisir)</td>
