		...
		<div class="card-body">
			<div class="col-md-12">
				...
				<div class="media-right">
					<button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#addmasterlokasipelatihan"><i class="fa fa-plus"></i> Tambah Data </button>
				</div>
			</div>
			<hr/>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<input type="text" class="form-control border-dark" id="nama_lokasi" name="nama_lokasi" placeholder="NAMA LOKASI" >
								</div>
							</div>
						</div>
