		...
		<div class="card-body">
			...
			<form action="<?php echo base_url('index.php/admin/setting/update') ?>" method="post" enctype="multipart/form-data">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" class="form-control border-dark" name="nama_info_pt" id="nama_info_pt" aria-describedby="nama_info_pt" placeholder="Nama Perusahaan" value="<?php echo $infopt->nama_info_pt ?>">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" class="form-control border-dark" name="kode_pt" id="kode_pt" aria-describedby="kode_pt" placeholder="Kode Perusahaan" value="<?php echo $infopt->kode_pt ?>">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control border-dark" name="slogan" id="slogan" aria-describedby="slogan" placeholder="Kode Perusahaan" value="<?php echo $infopt->slogan ?>">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" class="form-control border-dark" name="kontak_1" id="kontak_1" aria-describedby="kontak_1" placeholder="Nomor yang dapat dihubungi" value="<?php echo $infopt->kontak_1 ?>">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" class="form-control border-dark" name="kontak_2" id="kontak_2" aria-describedby="kontak_2" placeholder="Nomor yang dapat dihubungi" value="<?php echo $infopt->kontak_2 ?>">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" class="form-control border-dark" name="kontak_3" id="kontak_3" aria-describedby="kontak_3" placeholder="Nomor yang dapat dihubungi" value="<?php echo $infopt->kontak_3 ?>">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" class="form-control border-dark" name="kontak_4" id="kontak_4" aria-describedby="kontak_4" placeholder="Nomor yang dapat dihubungi" value="<?php echo $infopt->kontak_4 ?>">
				...
				<div class="form-group">
					...
					<textarea name="alamat_pt" class="form-control border-dark"><?php echo $infopt->alamat_pt; ?></textarea>
