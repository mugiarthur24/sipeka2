		...
		<div class="card-header">
			<div class="media">
				<div class="media-body">
					<h5 class="mt-0 mb-1">Daftar Pengajuan Surat Ijin Cuti</h5>
				</div>
				<div class="ml-3">
					<button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#addcuti">
			...
			<table class="table">
				...
				<?php foreach ($hasil as $data): ?>
					<tr>
						...
						<td class=""><a href="<?php echo base_url('index.php/admin/cssuket/detail_cuti/'.@$data->id_form_cuti) ?>"><?php echo $this->Admin_m->detail_data_order('data_pegawai','id_pegawai',$data->id_pegawai)->nama_pegawai; ?></a></td>
						...
						<?php if ($data->verifikasi_1 == '2' && $data->verifikasi_2 == '2' && $data->verifikasi_3 == '2' && $data->verifikasi_4 == '2' && $data->verifikasi_5 == '2' && $data->verifikasi_6 == '2' && $data->verifikasi_7 == '2'): ?>
							...
							<td class="text-center"><a href="<?php echo base_url('index.php/admin/cssuket/ctk_ijincuti/'.$data->id_form_cuti) ?>"><img src="<?php echo base_url('asset/img/printer.svg') ?>" width="25" height="25"></a></td>
						<?php else: ?>
...
<!-- Modal -->
<div class="modal fade" id="addcuti" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
$('#caripegawai').keyup(function() { // Jika select box id kurir dipilih
  	...
  	$.ajax({
            ...
            url: "<?php echo base_url('index.php/admin/cssuket/caripegawaicuti/'); ?>",
